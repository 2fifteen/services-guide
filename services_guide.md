...
> **Heads up!** Our audit is focused on identifying potential issues, but it doesn't include fixing them. If something needs fixing that is not covered by our managed services outlined in the quote, it will be addressed separately, and we'll provide you with a separate quote for that work.
...
> **Note:** In quotes, this is summarized as On-site and Remote Support, or Automated Support.
...
We've got your back(up). We set up and manage a backup and file recovery system using third-party solutions. This includes:

- 24/7 automated monitoring of your backups, including offsite and onsite backups (if applicable and compatible).
- Fixing any issues with backup disks.
...
> **Note:** The availability of specific features of network monitoring will depend on the specific equipment that is installed. We always monitor what we are able to for clients, based on the compatibility of their networks with our monitoring and alerting systems.
...
> **Note:** Email threat protection is only available for Google Workspace or Microsoft 365 accounts
...
> **Important Note:** 2Fifteen Tech does not warrant or guarantee the performance, availability, or reliability of any third-party tool, platform, or service. Support for third-party systems is offered on a best-effort basis and is subject to the availability and limitations of those systems.
...
> **Note:** Discounts are typically applied when customers agree to annual agreements instead of flexible month-to-month agreements. The customer is responsible for the full amount of that contract.
...
> **Note:** To mitigate against the unintentional loss of data, we strongly advise the client to keep multiple backup copies of all important stored data.
